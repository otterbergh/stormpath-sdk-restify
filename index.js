...
function createMiddleware(spConfig) {
  ...
  */
  ...
  autoRouter.attachDefaults = function(app){
    ...
    app.opts(context.spConfig.tokenEndpoint,boundMiddleware.authenticateForToken);
    app.post(context.spConfig.resendEmailVerificationEndpoint,boundMiddleware.resendEmailVerification);
    app.opts(context.spConfig.resendEmailVerificationEndpoint,boundMiddleware.resendEmailVerification);
    app.post(context.spConfig.emailVerificationTokenCollectionEndpoint,boundMiddleware.verifyEmailVerificationToken);
    app.opts(context.spConfig.emailVerificationTokenCollectionEndpoint,boundMiddleware.verifyEmailVerificationToken);
    ...
    app.opts(context.spConfig.passwordResetTokenCollectionEndpoint +'/:sptoken?',boundMiddleware.passwordReset);
  };
